package com.hanwintech.project.security;
/**   
 *  
 *  
 * @ProjectName: project
 * @Package: com.hanwintech.project.security    
 * @ClassName: ShiroManageFilterFactoryBean     
 * @Description:  该类作为shiro安全框架的自定义验证规则过滤器，可在shiroConfiguration中进行设置
 * @Author:  lee       
...
public class ShiroManageFilterFactoryBean extends ShiroFilterFactoryBean {
	 // 对ShiroFilter来说，需要直接忽略的请求
    private Set<String> ignoreExt;

    public ShiroManageFilterFactoryBean() {
        super();
